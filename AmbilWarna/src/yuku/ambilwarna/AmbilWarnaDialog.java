...
public class AmbilWarnaDialog {
	 ...
	 */
	public AmbilWarnaDialog(final Context context, int color, OnAmbilWarnaListener listener,String Colorss) {
		...
		viewOldColor.setBackgroundColor(Color.parseColor(Colorss));
